...
const Docs: NextPage<Props> = ({ packages }) => {
	return (
        ...
        >
          ...
          <p>
            All the docs pages below "Advanced Docs" are currently in
            development. There will likely be bugs. They're meant to be a
            simplified version of the typedoc docs, but they will certainly be
            lacking for those who are advanced users.{" "}
            <a href="https://github.com/zaida04/guilded.js/issues">
