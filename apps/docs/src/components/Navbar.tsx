		...
		<div>
			<nav className="flex items-center justify-between flex-wrap bg-black p-6 md:pl-40">
				...
				<div className="block md:hidden">
					<button className="flex items-center px-3 py-2 border rounded text-guilded border-guilded hover:text-white hover:border-white" type="button" onClick={() => setExpanded(!expanded)}>
