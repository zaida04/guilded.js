...
export class ForumsService {
     ...
     * @throws ApiError
     */
    public forumTopicDelete({ channelId, forumTopicId }: { channelId: string; forumTopicId: number }): CancelablePromise<void> {
        return this.httpRequest.request({
            method: "DELETE",
            url: "/channels/{channelId}/topics/{forumTopicId}",
            path: {
     ...
     * @throws ApiError
     */
    public forumTopicPin({ channelId, forumTopicId }: { channelId: string; forumTopicId: number }): CancelablePromise<void> {
        return this.httpRequest.request({
            method: "PUT",
     ...
     * @throws ApiError
     */
    public forumTopicUnpin({ channelId, forumTopicId }: { channelId: string; forumTopicId: number }): CancelablePromise<void> {
        return this.httpRequest.request({
            method: "DELETE",
            url: "/channels/{channelId}/topics/{forumTopicId}/pin",
            path: {
     ...
     * @throws ApiError
     */
    public forumTopicLock({ channelId, forumTopicId }: { channelId: string; forumTopicId: number }): CancelablePromise<void> {
        return this.httpRequest.request({
            method: "PUT",
     ...
     * @throws ApiError
     */
    public forumTopicUnlock({ channelId, forumTopicId }: { channelId: string; forumTopicId: number }): CancelablePromise<void> {
        return this.httpRequest.request({
            method: "DELETE",
            url: "/channels/{channelId}/topics/{forumTopicId}/lock",
            path: {
