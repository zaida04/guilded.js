...
export class ListItemsService {
     ...
     * @throws ApiError
     */
    public listItemDelete({ channelId, listItemId }: { channelId: string; listItemId: string }): CancelablePromise<void> {
        return this.httpRequest.request({
            method: "DELETE",
            url: "/channels/{channelId}/items/{listItemId}",
            path: {
     ...
     * @throws ApiError
     */
    public listItemCompleteCreate({ channelId, listItemId }: { channelId: string; listItemId: string }): CancelablePromise<void> {
        return this.httpRequest.request({
            method: "POST",
     ...
     * @throws ApiError
     */
    public listItemCompleteDelete({ channelId, listItemId }: { channelId: string; listItemId: string }): CancelablePromise<void> {
        return this.httpRequest.request({
            method: "DELETE",
            url: "/channels/{channelId}/items/{listItemId}/complete",
            path: {
