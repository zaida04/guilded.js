...
export class AnnouncementCommentsService {
     ...
     * @throws ApiError
     */
    public announcementCommentDelete({ channelId, announcementId, announcementCommentId }: { channelId: string; announcementId: string; announcementCommentId: number }): CancelablePromise<void> {
        return this.httpRequest.request({
            method: "DELETE",
            url: "/channels/{channelId}/announcements/{announcementId}/comments/{announcementCommentId}",
            path: {
