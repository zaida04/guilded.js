...
export class ForumCommentsService {
     ...
     * @throws ApiError
     */
    public forumTopicCommentDelete({ channelId, forumTopicId, forumTopicCommentId }: { channelId: string; forumTopicId: number; forumTopicCommentId: number }): CancelablePromise<void> {
        return this.httpRequest.request({
            method: "DELETE",
            url: "/channels/{channelId}/topics/{forumTopicId}/comments/{forumTopicCommentId}",
            path: {
