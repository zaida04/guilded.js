...
import { type parsedMessage, type MessageAttachment, type WebhookMessageContent, parseMessage, transformEmbedToAPIEmbed } from "../util/message";
...
export class WebhookClient {
    ...
    public constructor(webhookConnection: string | { id: string; token: string }, { username, avatarURL }: { avatarURL?: string; username?: string } = {}) {
    ...
    public async send(
        ...
        const data = await this.rest.post<RESTPostWebhookResult, FormData | RESTPostWebhookBody>("", body);
