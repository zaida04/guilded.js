import type { APIEmbed } from "../../generated/api-typings";
...
export class WebhookEmbed {
	...
	public setColor(
		color?: number | string | [number, number, number] | null
	): this {
	...
	public setFooter(
		...
		this.footer = text
			? { iconURL: iconURL ?? null, proxyIconURL: proxyIconURL ?? null, text }
			: null;
		return this;
	}
	...
	public setProvider(name?: string | null, url?: string | null): this {
		this.provider =
			name && url ? { name: name ?? null, url: url ?? null } : null;
		return this;
	}
...
export type APIWebhookEmbedMediaData = {
	height: string | null;
	proxyURL: string | null;
	url: string;
	width: string | null;
