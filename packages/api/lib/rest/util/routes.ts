...
export const ROUTES = {
	...
	calendarEventRsvp: (channelId: string, calendarEventId: number, userId: string) => `/channels/${channelId}/events/${calendarEventId}/rsvps/${userId}` as const,

	calendarEventRsvpsMany: (channelId: string, calendarEventId: number) => `/channels/${channelId}/events/${calendarEventId}/rsvps` as const,
	...
	forumTopicLock: (channelId: string, forumTopicId: string) => `/channels/${channelId}/topics/${forumTopicId}/lock` as const,
	...
	// Reactions Endpoints
	channelReaction: (channelId: string, contentId: string, emoteId: number) => `/channels/${channelId}/content/${contentId}/emotes/${emoteId}` as const,
	...
	memberSocialLinks: (serverId: string, userId: string, type: SocialLinkPayload["type"]) => `/servers/${serverId}/members/${userId}/social-links/${type}` as const,
