...
export const ROUTES = {
	...
	members: (
		...
		`/servers/${serverId}/members` as const,
	memberBan: (
		serverId: string,
		userId: string,
	) =>
	...
	memberBans: (
		...
		`/servers/${serverId}/bans` as const,
	...
	forumTopics: (
		...
		`/channels/${channelId}/topics` as const,
	forumTopic: (
		channelId: string,
		forumTopicId: string,
	) =>
	...
	listItems: (
		...
		`/channels/${channelId}/items` as const,
	listItem: (
		channelId: string,
		itemId: string,
	) =>
	...
	channelDocs: (
		...
		`/channels/${channelId}/docs` as const,
	channelDoc: (
		channelId: string,
		docId: number,
	) =>
