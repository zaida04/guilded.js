export const constants = {
  clientEvents: {
    ...
    FORUM_TOPIC_COMMENT_CREATED: "forumTopicCommentCreated",
    FORUM_TOPIC_COMMENT_UPDATED: "forumTopicCommentUpdated",
    FORUM_TOPIC_COMMENT_DELETED: "forumTopicCommentDeleted",
  },
} as const;
