...
import type { ServerMemberPayload, UserSummaryPayload } from "@guildedjs/guilded-api-typings";
...
export class Member extends Base<UpgradedServerMemberPayload> {
	...
	_update(data: Partial<ServerMemberPayload & { kicked: boolean; banned: boolean }>): this {
		if ("nickname" in data) {
