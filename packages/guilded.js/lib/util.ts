...
export const ASSET_BUILDER = {
	 ...
	 */
    SERVER_BANNER: (hash: string, size = "Hero", width?: number, height?: number): string =>
	 ...
	 */
	SERVER_EMOJI: (hash: string, size = "Full", extension: "WEBP" | "APNG" = "WEBP", width?: number, height?: number): string =>
	 ...
	 */
	SERVER_ICON: (hash: string, size: "Small" | "Medium" | "Large" = "Medium"): string =>
