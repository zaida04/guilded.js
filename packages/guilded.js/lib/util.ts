...
/**
 * Builds a key for a comment object in a server for use in cache management.
 *
 * @param channelId - The ID of the channel.
 * @param objectId - The ID of the object this comment was created in (forum topic, docs, announcement, etc.).
 * @param commentId - The ID of the comment.
 *
 * @returns The key for the comment object.
 */
export const buildCommentKey = (
  channelId: string,
  objectId: string | number,
  commentId: string | number
): string => {
  return `${channelId}:${objectId}:${commentId}`;
};
...
export const buildCalendarRsvpKey = (
