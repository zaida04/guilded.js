import type { RESTGetForumTopicsQuery, RESTPatchForumTopicBody, RESTPostForumTopicBody } from "@guildedjs/guilded-api-typings";
...
export class GlobalForumTopicManager extends CacheableStructManager<number, ForumTopic> {
     ...
     */
    create(channelId: string, options: RESTPostForumTopicBody): Promise<ForumTopic> {
        return this.client.rest.router.createForumTopic(channelId, options).then((data) => new ForumTopic(this.client, data.forumTopic));
    }
     ...
     */
    fetchMany(channelId: string, options: RESTGetForumTopicsQuery): Promise<Collection<number, PartialForumTopic>> {
        return this.client.rest.router.getForumTopics(channelId, options).then(data => {
    ...
    fetch(channelId: string, forumTopicId: number): Promise<ForumTopic> {
        return this.client.rest.router.getForumTopic(channelId, forumTopicId.toString()).then(data => new ForumTopic(this.client, data.forumTopic));
    }
     ...
     */
    update(channelId: string, forumThreadId: string, options: RESTPatchForumTopicBody): Promise<ForumTopic> {
        return this.client.rest.router.updateForumTopic(channelId, forumThreadId, options).then((data) => {
    ...
    delete(channelId: string, forumThreadId: string): Promise<void> {
        return this.client.rest.router.deleteForumTopic(channelId, forumThreadId).then(() => void 0);
    }
    ...
    pin(channelId: string, forumThreadId: string): Promise<void> {
        return this.client.rest.router.pinForumTopic(channelId, forumThreadId).then(() => void 0);
    }
    ...
    unpin(channelId: string, forumThreadId: string): Promise<void> {
        return this.client.rest.router.unpinForumTopic(channelId, forumThreadId).then(() => void 0);
    }
    ...
    lock(channelId: string, forumThreadId: string): Promise<void> {
        return this.client.rest.router.lockForumTopic(channelId, forumThreadId).then(() => void 0);
    }
    ...
    unlock(channelId: string, forumThreadId: string): Promise<void> {
        return this.client.rest.router.unlockForumTopic(channelId, forumThreadId).then(() => void 0);
    }
}
