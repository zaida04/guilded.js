...
export class ClientGatewayHandler {
  ...
  readonly eventToHandlerMap: Record<
    keyof WSEvent,
    (data: SkeletonWSPayload) => Promise<boolean> | boolean
  > = {
    ...
    [WebSocketEvents.ListItemCompleted]: (data) =>
      this.listHandler.listItemCompleted(data as WSPacket<"ListItemCompleted">),
    ...
    [WebSocketEvents.ListItemCreated]: (data) =>
      this.listHandler.listItemCreated(data as WSPacket<"ListItemCreated">),
    [WebSocketEvents.ListItemUpdated]: (data) =>
      this.listHandler.listItemUpdated(data as WSPacket<"ListItemUpdated">),
    [WebSocketEvents.ListItemDeleted]: (data) =>
      this.listHandler.listItemDeleted(data as WSPacket<"ListItemDeleted">),
    [WebSocketEvents.DocCreated]: (data) =>
      this.docHandler.docCreated(data as WSPacket<"DocCreated">),
    [WebSocketEvents.DocDeleted]: (data) =>
      this.docHandler.docDeleted(data as WSPacket<"DocDeleted">),
    [WebSocketEvents.DocUpdated]: (data) =>
      this.docHandler.docUpdated(data as WSPacket<"DocUpdated">),
    ...
    [WebSocketEvents.ForumTopicPinned]: (data) =>
      this.forumHandler.forumTopicPinned(data as WSPacket<"ForumTopicPinned">),
    ...
    [WebSocketEvents.ForumTopicLocked]: (data) =>
      this.forumHandler.forumTopicLocked(data as WSPacket<"ForumTopicLocked">),
