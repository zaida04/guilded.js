...
export class ClientGatewayHandler {
	...
	> = {
			...
			[WebSocketEvents.ChatMessageCreated]: (data) =>
				this.messageHandler.messageCreated(data as WSPacket<"ChatMessageCreated">),
			[WebSocketEvents.ChatMessageDeleted]: (data) =>
				this.messageHandler.messageDeleted(data as WSPacket<"ChatMessageDeleted">),
			[WebSocketEvents.ChatMessageUpdated]: (data) =>
				this.messageHandler.messageUpdated(data as WSPacket<"ChatMessageUpdated">),
			...
			[WebSocketEvents.ListItemUncompleted]: (data) =>
				this.listHandler.listItemUncompleted(data as WSPacket<"ListItemUncompleted">),
			...
			[WebSocketEvents.ForumTopicCreated]: (data) =>
				this.forumHandler.forumTopicCreated(data as WSPacket<"ForumTopicCreated">),
			[WebSocketEvents.ForumTopicDeleted]: (data) =>
				this.forumHandler.forumTopicDeleted(data as WSPacket<"ForumTopicDeleted">),
			[WebSocketEvents.ForumTopicUpdated]: (data) =>
				this.forumHandler.forumTopicUpdated(data as WSPacket<"ForumTopicUpdated">),
			...
			[WebSocketEvents.ForumTopicUnpinned]: (data) =>
				this.forumHandler.forumTopicUnpinned(data as WSPacket<"ForumTopicUnpinned">),
			...
			[WebSocketEvents.ForumTopicUnlocked]: (data) =>
				this.forumHandler.forumTopicUnlocked(data as WSPacket<"ForumTopicUnlocked">),
		};
