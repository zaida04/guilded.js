...
export type MessageContent =
	| Embed
	| OptionBody<
			ChatService["channelMessageCreate"]
	  >
	| string
	| (Omit<
			OptionBody<
...
export type ClientEvents = {
	...
	messageReactionDeleted(
		event: MessageReactionDeletedEvent,
	): unknown;
	channelCreated(
		channel: Channel,
	): unknown;
