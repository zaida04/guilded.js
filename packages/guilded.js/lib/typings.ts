...
export type MessageContent = Embed | OptionBody<ChatService["channelMessageCreate"]> | string | (Omit<OptionBody<ChatService["channelMessageCreate"]>, "embeds"> & { embeds?: Embed[] });
